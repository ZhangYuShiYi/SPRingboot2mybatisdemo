...
public class RequestUtil {
	...
	public static void handleWithResponse(HttpServletResponse response, String responseStr) throws Exception{
		...
		try {
			...
			e.printStackTrace();
			throw new Exception("Failed to response");
		}
	}

	public static String buildURLParams(String returnUrl, String filterKey) {
		if (StringUtils.isBlank(returnUrl)) return "";
	...
	public static String buildAppendURLParams(String returnUrl, String... params) {
		if (StringUtils.isBlank(returnUrl) || params.length == 0) return returnUrl;
