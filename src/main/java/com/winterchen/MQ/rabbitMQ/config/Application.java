package com.winterchen.MQ.rabbitMQ.config;
...
public class Application {
    ...
    /**
     * 将队列dirQueue与directExchange交换机绑定，routing_key为directQueue
     */
    @Bean
    ...
    Binding bindingExchangeDirect(@Qualifier("dirQueue")Queue dirQueue,DirectExchange directExchange){
        return  BindingBuilder.bind(dirQueue).to(directExchange).with("directQueue");
    }
    ...
    TopicExchange exchange() {
        return new TopicExchange("exchange");  // 参数1为交换机的名称
    }
